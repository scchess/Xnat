...
(function(spawn){
    ...
    var examples = {
        ...
        withText: {
            ...
            input:  spawn('p#fox', 'The quick brown fox... did some stuff.'),
        ...
        nestedDeep: {
            ...
            input: spawn('div#outer.stuff|title="The Outer Div."', [
                ['p.inner1', [
                    ...
                    ['script', 'alert("Why would you want to add a script tag here? You can if you want. It will be executed immediately.")']
                ]]
            ]),
            output:
                '<div id="outer" class="stuff" title="The Outer Div">' +
                    '<p class="inner1">' +
                        ...
                        '<script>alert("Why would you want to add a script tag here? You can if you want. It will be executed immediately.")</script>' +
                    '</p>' +
                '</div>'
        },
        ...
        configObj1: {
            ...
            input: spawn('button#a-list', {
                type: 'button',
                name: 'a-list',
                html: 'The A-List Button', // 'html' is a shortcut for the 'innerHTML' property
                ...
                $: { // the $ property attaches jQuery methods to the spawned element
                    after: spawn('b.after', 'Some bold text can be spawned and, using jQuery, will be added after the spawned element.'),
                    addClass: 'a-button',
