...
public class DicomSCPManager {
    ...
    public DicomSCP create(final DicomSCPInstance instance) throws IOException, DICOMReceiverWithDuplicateAeTitleException, EnabledDICOMReceiverWithDuplicatePortException {
    ...
    public void setDicomSCPInstance(final DicomSCPInstance instance) throws DICOMReceiverWithDuplicateAeTitleException, EnabledDICOMReceiverWithDuplicatePortException {
        try {
            _dicomScpPreferences.setDicomSCPInstance(instance);
        } catch (IOException e) {
    ...
    public void enableDicomSCP(final int id) throws DICOMReceiverWithDuplicateAeTitleException, EnabledDICOMReceiverWithDuplicatePortException {
        final DicomSCPInstance instance = _dicomScpPreferences.getDicomSCPInstance(id);
        try {
            if (!instance.isEnabled()) {
