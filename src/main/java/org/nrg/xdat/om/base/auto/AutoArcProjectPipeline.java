...
public abstract class AutoArcProjectPipeline extends ArcPipelinedata implements org.nrg.xdat.model.ArcProjectPipelineI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(AutoArcProjectPipeline.class);
	public static String SCHEMA_ELEMENT_NAME="arc:project_pipeline";

	public AutoArcProjectPipeline(ItemI item)
	{
		super(item);
	}

	public AutoArcProjectPipeline(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoArcProjectPipeline(UserI user)
	 **/
	public AutoArcProjectPipeline(){}

	public AutoArcProjectPipeline(Hashtable properties,UserI user)
	{
	...
	public static ArrayList<org.nrg.xdat.om.ArcProjectPipeline> getAllArcProjectPipelines(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.ArcProjectPipeline> al = new ArrayList<org.nrg.xdat.om.ArcProjectPipeline>();
	...
	public static ArrayList<org.nrg.xdat.om.ArcProjectPipeline> getArcProjectPipelinesByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.ArcProjectPipeline> al = new ArrayList<org.nrg.xdat.om.ArcProjectPipeline>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.ArcProjectPipeline> getArcProjectPipelinesByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.ArcProjectPipeline> al = new ArrayList<org.nrg.xdat.om.ArcProjectPipeline>();
		try {
	...
	public static ArcProjectPipeline getArcProjectPipelinesByArcPipelinedataId(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("arc:project_pipeline/arc_pipelinedata_id",value,user,preLoad);
			ItemI match = items.getFirst();
			if (match!=null)
				return (ArcProjectPipeline) org.nrg.xdat.base.BaseElement.GetGeneratedItem(match);
			else
				 return null;
		} catch (Exception e) {
			logger.error("",e);
