...
public abstract class AutoXnatEsvsessiondata extends XnatImagesessiondata implements org.nrg.xdat.model.XnatEsvsessiondataI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(AutoXnatEsvsessiondata.class);
	public static String SCHEMA_ELEMENT_NAME="xnat:esvSessionData";

	public AutoXnatEsvsessiondata(ItemI item)
	{
		super(item);
	}

	public AutoXnatEsvsessiondata(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoXnatEsvsessiondata(UserI user)
	 **/
	public AutoXnatEsvsessiondata(){}

	public AutoXnatEsvsessiondata(Hashtable properties,UserI user)
	{
	...
	public static ArrayList<org.nrg.xdat.om.XnatEsvsessiondata> getAllXnatEsvsessiondatas(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatEsvsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatEsvsessiondata>();
	...
	public static ArrayList<org.nrg.xdat.om.XnatEsvsessiondata> getXnatEsvsessiondatasByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatEsvsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatEsvsessiondata>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.XnatEsvsessiondata> getXnatEsvsessiondatasByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatEsvsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatEsvsessiondata>();
		try {
	...
	public static XnatEsvsessiondata getXnatEsvsessiondatasById(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("xnat:esvSessionData/id",value,user,preLoad);
