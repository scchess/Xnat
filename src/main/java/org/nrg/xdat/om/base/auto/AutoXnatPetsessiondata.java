...
public abstract class AutoXnatPetsessiondata extends XnatImagesessiondata implements org.nrg.xdat.model.XnatPetsessiondataI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(AutoXnatPetsessiondata.class);
	public static String SCHEMA_ELEMENT_NAME="xnat:petSessionData";

	public AutoXnatPetsessiondata(ItemI item)
	{
		super(item);
	}

	public AutoXnatPetsessiondata(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoXnatPetsessiondata(UserI user)
	 **/
	public AutoXnatPetsessiondata(){}

	public AutoXnatPetsessiondata(Hashtable properties,UserI user)
	{
	...
	public static ArrayList<org.nrg.xdat.om.XnatPetsessiondata> getAllXnatPetsessiondatas(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatPetsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatPetsessiondata>();
	...
	public static ArrayList<org.nrg.xdat.om.XnatPetsessiondata> getXnatPetsessiondatasByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatPetsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatPetsessiondata>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.XnatPetsessiondata> getXnatPetsessiondatasByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatPetsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatPetsessiondata>();
		try {
	...
	public static XnatPetsessiondata getXnatPetsessiondatasById(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("xnat:petSessionData/id",value,user,preLoad);
			ItemI match = items.getFirst();
			if (match!=null)
				return (XnatPetsessiondata) org.nrg.xdat.base.BaseElement.GetGeneratedItem(match);
			else
				 return null;
		} catch (Exception e) {
			logger.error("",e);
