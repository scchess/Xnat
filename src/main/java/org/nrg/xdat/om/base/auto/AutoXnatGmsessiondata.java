...
public abstract class AutoXnatGmsessiondata extends XnatImagesessiondata implements org.nrg.xdat.model.XnatGmsessiondataI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(AutoXnatGmsessiondata.class);
	public static String SCHEMA_ELEMENT_NAME="xnat:gmSessionData";

	public AutoXnatGmsessiondata(ItemI item)
	{
		super(item);
	}

	public AutoXnatGmsessiondata(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoXnatGmsessiondata(UserI user)
	 **/
	public AutoXnatGmsessiondata(){}

	public AutoXnatGmsessiondata(Hashtable properties,UserI user)
	{
	...
	public static ArrayList<org.nrg.xdat.om.XnatGmsessiondata> getAllXnatGmsessiondatas(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatGmsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatGmsessiondata>();
	...
	public static ArrayList<org.nrg.xdat.om.XnatGmsessiondata> getXnatGmsessiondatasByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatGmsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatGmsessiondata>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.XnatGmsessiondata> getXnatGmsessiondatasByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatGmsessiondata> al = new ArrayList<org.nrg.xdat.om.XnatGmsessiondata>();
		try {
	...
	public static XnatGmsessiondata getXnatGmsessiondatasById(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("xnat:gmSessionData/id",value,user,preLoad);
			ItemI match = items.getFirst();
			if (match!=null)
				return (XnatGmsessiondata) org.nrg.xdat.base.BaseElement.GetGeneratedItem(match);
			else
				 return null;
		} catch (Exception e) {
			logger.error("",e);
