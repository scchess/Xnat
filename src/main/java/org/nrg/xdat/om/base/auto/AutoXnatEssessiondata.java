...
public abstract class AutoXnatEssessiondata extends XnatImagesessiondata implements org.nrg.xdat.model.XnatEssessiondataI {
	public static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(AutoXnatEssessiondata.class);
	public static String SCHEMA_ELEMENT_NAME="xnat:esSessionData";

	public AutoXnatEssessiondata(ItemI item)
	{
		super(item);
	}

	public AutoXnatEssessiondata(UserI user)
	{
		super(user);
	}

	/*
	 * @deprecated Use AutoXnatEssessiondata(UserI user)
	 **/
	public AutoXnatEssessiondata(){}

	public AutoXnatEssessiondata(Hashtable properties,UserI user)
	{
	...
	public static ArrayList<org.nrg.xdat.om.XnatEssessiondata> getAllXnatEssessiondatas(org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatEssessiondata> al = new ArrayList<org.nrg.xdat.om.XnatEssessiondata>();
	...
	public static ArrayList<org.nrg.xdat.om.XnatEssessiondata> getXnatEssessiondatasByField(String xmlPath, Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatEssessiondata> al = new ArrayList<org.nrg.xdat.om.XnatEssessiondata>();
		try {
	...
	public static ArrayList<org.nrg.xdat.om.XnatEssessiondata> getXnatEssessiondatasByField(org.nrg.xft.search.CriteriaCollection criteria, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		ArrayList<org.nrg.xdat.om.XnatEssessiondata> al = new ArrayList<org.nrg.xdat.om.XnatEssessiondata>();
		try {
	...
	public static XnatEssessiondata getXnatEssessiondatasById(Object value, org.nrg.xft.security.UserI user,boolean preLoad)
	{
		try {
			org.nrg.xft.collections.ItemCollection items = org.nrg.xft.search.ItemSearch.GetItems("xnat:esSessionData/id",value,user,preLoad);
			ItemI match = items.getFirst();
			if (match!=null)
				return (XnatEssessiondata) org.nrg.xdat.base.BaseElement.GetGeneratedItem(match);
			else
				 return null;
		} catch (Exception e) {
			logger.error("",e);
