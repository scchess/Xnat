...
public interface CatalogService {
     ...
     *                      presumed.
     */
    void refreshResourceCatalog(final UserI user, final String resource, final Operation... operations) throws ActionException;
     ...
     *                      presumed.
     */
    void refreshResourceCatalog(final UserI user, final String resource, final Collection<Operation> operations) throws ActionException;
     ...
     *                      presumed.
     */
    void refreshResourceCatalogs(final UserI user, final List<String> resources, final Operation... operations) throws ActionException;
     ...
     *                      presumed.
     */
    void refreshResourceCatalogs(final UserI user, final List<String> resources, final Collection<Operation> operations) throws ActionException;
}
